...
function HeroSection() {
  return (
    <div className="w-full min-h-screen bg-black flex flex-col justify-center items-center text-white relative">
      <div className="w-[0.5px] h-full bg-white absolute top-0 left-12 sm:left-16 md:left-20 lg:left-24" />
      <div className="w-[0.5px] h-full bg-white absolute top-0 right-12 sm:right-16 md:right-20 lg:right-24" />
